const soilLatest = '/soil/latest/by-lat-lng';
const fireLatest = '/latest/fire';
const pollenLatest = '/latest/pollen/by-lat-lng';
const pollenForecast = '/forecast/pollen/by-lat-lng';
